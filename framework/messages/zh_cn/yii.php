...
return array (
  ...
  'Unable to add an item whose name is the same as an existing item.' => '无法新增与已存在项目业务名称相同的新项目.',
  'Unable to change the item name. The name "{name}" is already used by another item.' => '无法变更项目业务名称. 业务名称 "{name}" 已被其它项目使用.',
  ...
  '{class} does not support fetching all table names.' => '{class} 不支持撷取所有 table 业务名称.',
  '{class} has an invalid validation rule. The rule must specify attributes to be validated and the validator name.' => '{class} 有一个无效的确认规则. 规则必须指明要被确认的属性以及确认器业务名称.',
